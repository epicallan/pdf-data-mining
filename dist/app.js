...
/***/ function(module, exports, __webpack_require__) {
	...
	var _verbalExpressions = __webpack_require__(3);
	...
	var isNewTableTitleExpressions = function isNewTableTitleExpressions(segments) {
	  return segments.map(function (segment) {
	    return (0, _verbalExpressions2.default)().find(segment.tableTitle);
	  });
	};
	...
	function main(segments) {
	  var readFileByLine = _readline2.default.createInterface({
	    input: _fs2.default.createReadStream('2014-15.txt')
	  });
